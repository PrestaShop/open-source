...
Please read carefully [IP Right Policies document](https://github.com/PrestaShop/open-source/blob/master/user-groups/ip-right-policies.pdf), available on this GitHub repository. You can read it right here on GitHub, or download it.


## Step 2, use the templates

When you have read the guidelines and you are ready to follow them, you can then download the [ZIP archive with all the templates](https://github.com/PrestaShop/open-source/blob/master/user-groups/PrestaShop_Privacy_Policies.zip).
