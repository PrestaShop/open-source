...
- Dependencies, librairies and artwork distributed in the ZIP for installation must be in [compatible licenses](https://devdocs.prestashop-project.org/1.7/contribute/contribution-guidelines/compatible-licenses/)
